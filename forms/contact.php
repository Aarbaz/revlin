...
$mail = new PHPMailer(true);
    ...
    //Recipients
    $mail->setFrom('leads.engravemedia@gmail.com', 'DP Builds');
    //Add a recipient
    $mail->addAddress('hrishikesh.amrale@gmail.com');               //Name is optional
    $mail->addAddress('abzansari19e@gmail.com');               //Name is optional
    ...
    $mail->Body    = "Name:". ' ' .$_POST['c_name'] . "<br/> Phone:". ' ' . $_POST['c_phone']."<br/> Flat type:".' '. $_POST['flats_type'];
